<div class="form-group {{ $errors->has('team_name') ? 'has-error' : ''}}">
    ...
    <div class="col-md-6">
        {!! Form::text('team_name', null, ('required' == 'required') ? ['class' => 'form-control', 'required' => 'required'] : ['class' => 'form-control']) !!}
    ...
    <div class="col-md-6">
        {!! Form::text('short_name', null, ('required' == 'required') ? ['class' => 'form-control', 'required' => 'required'] : ['class' => 'form-control']) !!}
