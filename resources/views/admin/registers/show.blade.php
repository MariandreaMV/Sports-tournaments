                        ...
                        <div class="table-responsive">
                            <table class="table table-borderless">
                                <tbody>
                                    ...
                                    <tr><th> Tournament Id </th><td> {{ $register->tournament_id }} </td></tr><tr><th> Team Id </th><td> {{ $register->team_id }} </td></tr><tr><th> N Participants </th><td> {{ $register->n_participants }} </td></tr><tr><th> Category </th><td> {{ $register->category }} </td></tr>
                                </tbody>
                            </table>
                        </div>
